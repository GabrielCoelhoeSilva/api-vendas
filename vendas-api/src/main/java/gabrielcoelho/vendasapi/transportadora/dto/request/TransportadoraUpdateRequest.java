...
/**
 * DTO utilizado na atualização (PUT) de uma transportadora existente.
 *
 * Propositalmente NÃO possui o campo "codigo": a estrutura do DTO já
 * impede, em tempo de compilação, que o código seja alterado após o
 * cadastro, reforçando a regra de negócio nº 5.
 */
@Getter
@Setter
@NoArgsConstructor
